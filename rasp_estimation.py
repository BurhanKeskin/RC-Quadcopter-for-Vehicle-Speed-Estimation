...
def speed_estimation(source_video, target_video):
    source_video_path =  source_video    # data\\MVI_0577_Stabilized_3.mp4
    target_video_path = target_video     # data\\isuzu7.mp4
    confidence_threshold = 0.3
    iou_threshold = 0.7
    speed_limit = 80  # km/h, belirlenen hız sınırı
